...
![ФАйл](https://user-images.githubusercontent.com/97798186/201520585-7452fb4f-4a81-4de9-b75f-84734e523eab.jpg)

Затем протестировали программу на ассемблере:

![ФАйл](https://user-images.githubusercontent.com/97798186/201520621-335f7f7d-ecbd-4162-ba69-b9480fb7032a.jpg)

Вывод: программа на ассемблере с рефакторингом работает немного дольше.
...
![ФАйл](https://user-images.githubusercontent.com/97798186/201520918-9c9e9b2f-98ad-4dba-b0d8-ded5b8cbe8a7.jpg)

Для получения времени тестирования был использован File и запущен 100000 раз. Самые долгие показатели у программы без рефакторинга и у программы с опцией -О1. Следующие по производительности идут программы с опциями -О2 и -Оfast. Производительность программы с рефакторингом практически не отличается от производительности программы с оптимизацией по размеру. Программа с опциями оптимизации по скорости оказалась самой быстрой.
